    ...
    <div>
        ...
        ? userProfile && (
            <header className="relative h-52 overflow-hidden">
              ...
              />
              <button onClick={showCoverImage} className='flex cursor-pointer  items-center justify-end z-20 w-full p-5 absolute '>Change Image </button>
              ...
              <img
                  ...
                  alt=""
                />
                <button onClick={showAvatarImage} className='flex cursor-pointer  items-center justify-start z-20 w-full p-5 absolute '>Change avatar </button>
